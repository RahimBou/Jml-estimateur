...
function analyze(rows,input,geo){
  ...
  return{
    ...
    data:{source:'DVF+ géolocalisées — données ouvertes',millime:YEARS.join(', '),engineVersion:'V1.8.3-concurrence-pdf',localCenter:model.localCenterUsed}
  };
}
