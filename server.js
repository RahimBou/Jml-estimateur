...
function analyze(rows,input,geo){
  ...
  return{
    ...
    data:{source:'DVF+ géolocalisées — données ouvertes',millime:YEARS.join(', '),engineVersion:'V1.8.1-concurrence-pdf',localCenter:model.localCenterUsed}
  };
}
